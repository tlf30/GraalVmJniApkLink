...
public class JmeJfxHarness extends Fragment implements TouchListener, DialogInterface.OnClickListener, View.OnLayoutChangeListener, SystemListener {
    static {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        try {
            if (app == null) {
                app = (LegacyApplication) getJme(appClass);
            }
    ...
    public void handleError(final String errorMsg, final Throwable t) {
        ...
        getActivity().runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                builder.setPositiveButton("Kill", JmeJfxHarness.this);
                ...
                case KEY_UP:
                    getActivity().runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            builder.setPositiveButton("Yes", JmeJfxHarness.this);
                            builder.setNegativeButton("No", JmeJfxHarness.this);
...
//                    new Object[]{left, top, right, bottom});
    ...
    public native Object getJme(String claspath);
